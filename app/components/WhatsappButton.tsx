...
export default function WhatsappButton() {
  ...
  return (
    <a
      ...
      aria-hidden={hidden}
      tabIndex={hidden ? -1 : 0}
      className={`fixed bottom-6 right-6 z-50 flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#25D366] transition-opacity duration-300 hover:opacity-90 md:bottom-8 md:right-14 ${hidden ? "pointer-events-none opacity-0" : "opacity-100"
        }`}
    >
